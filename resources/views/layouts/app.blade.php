    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          @can('task-list')
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#task-layouts" aria-expanded="false" aria-controls="task-layouts">
              <i class="fa fa-users menu-icon"></i>
              <span class="menu-title">Manage Task</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="task-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('task.index')}}">List Task</a></li>
                @can('task-create')
                <li class="nav-item"> <a class="nav-link" href="{{route('task.create')}}">Add Task</a></li>
                @endcan
              </ul>
            </div>
          </li>
...
function assign_users(){
  $.ajax({
    ...
    success: function(data) {
      ...
      {
          $('<option/>').val(item.name).text(item.name).appendTo('#assign_user');
      });
    }
  });
}
